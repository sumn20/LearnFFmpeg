...
#ifndef LEARNFFMPEG_ACCOMPANY_DECODER_H
#define LEARNFFMPEG_ACCOMPANY_DECODER_H
...
private:
    ...
    /** 每次解码出来的audioBuffer 以及这个 audioBuffer的时间戳以及当前类对于这个audioBuffer的操作情况 **/
    short *audioBuffer;
...
#endif //LEARNFFMPEG_ACCOMPANY_DECODER_H
