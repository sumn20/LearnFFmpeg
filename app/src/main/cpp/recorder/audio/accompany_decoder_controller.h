...
#ifndef LEARNFFMPEG_ACCOMPANY_DECODER_CONTROLLER_H
#define LEARNFFMPEG_ACCOMPANY_DECODER_CONTROLLER_H
...
#endif //LEARNFFMPEG_ACCOMPANY_DECODER_CONTROLLER_H
