...
#ifndef LEARNFFMPEG_COMMON_TOOLS_H
#define LEARNFFMPEG_COMMON_TOOLS_H
...
inline int readShortFromFile(short *shortarray, int size, FILE* fp) {
    ...
    //	LOGCATI("read data expected size is %d and size is %d", size, actualSize);
    if (actualSize != size) {
...
#endif //LEARNFFMPEG_COMMON_TOOLS_H
